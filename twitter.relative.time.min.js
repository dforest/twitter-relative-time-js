...
other:"%n saniye \u00f6nce"},minute:{one:"%n dakika \u00f6nce",other:"%n dakika \u00f6nce"},hour:{one:"%n saat \u00f6nce",other:"%n saat \u00f6nce"},month:"%n Ocak;%n \u015eubat;%n Mart;%n Nisan;%n May\u0131s;%n Haziran;%n Temmuz;%n A\u011fustos;%n Eyl\u00fcl;%n Ekim;%n Kas\u0131m;%n Aral\u0131k".split(";")},"zh-CHS":{now:"\u73b0\u5728",second:{one:"%n\u79d2\u949f\u524d",other:"%n\u79d2\u949f\u524d"},minute:{one:"%n\u5206\u949f\u524d",other:"%n\u5206\u949f\u524d"},hour:{one:"%n\u5c0f\u65f6\u524d",
other:"%n\u5c0f\u65f6\u524d"},month:"1\u6708%n\u65e5 2\u6708%n\u65e5 3\u6708%n\u65e5 4\u6708%n\u65e5 5\u6708%n\u65e5 6\u6708%n\u65e5 7\u6708%n\u65e5 8\u6708%n\u65e5 9\u6708%n\u65e5 10\u6708%n\u65e5 11\u6708%n\u65e5 12\u6708%n\u65e5".split(" ")}};return function(a){void 0!==a&&e.hasOwnProperty(a)&&(d=a);a=new Date-this;a=Math.abs(a);var b="now",c;for(c in f){if(a<f[c])break;b=c;a/=f[c]}if("hour"===b&&1<=a/24)return g(this,"month",!0);a=Math.floor(a);return g(a,b)}}();