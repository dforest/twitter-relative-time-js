 ...
 */
 Date.prototype.toTwitterRelativeTime = (function() {
  ...
  var LOCALES = {
    ...
    he: {
      now: 'עכשיו',
      second: {one: 'לפני שניה', other: 'לפני %n שניות'},
      minute: {one: 'לפני דקה', other: 'לפני %n דקות'},
      hour:   {one: 'לפני שעה'  , other: 'לפני %n שעות'},
      month: ['%n ינואר','%n פברואר','%n מרץ','%n אפריל','%n מאי','%n יוני','%n יולי','%n אוגוסט','%n ספטמבר','%n אוקטובר','%n נובמבר','%n דצמבר']
    }
  }
